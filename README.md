...
- 🚀 **高性能**: QPS 0.77，P99延迟14秒，满足50人并发场景
...
### 压测结果（30并发请求，max_tokens=512）

| 指标 | Baseline | Hybrid+Rerank | 目标值 | 状态 |
|-----|----------|---------------|--------|------|
| **QPS** | 0.77 | 0.74 | ≥0.5 | ✅ +54% |
| **平均响应** | 11.37秒 | 10.93秒 | <15秒 | ✅ |
| **P99延迟** | 14.00秒 | 14.09秒 | <20秒 | ✅ |
| **TTFT** | 0.91秒 | 1.82秒 | <2秒 | ✅ |
| **成功率** | 100% | 100% | >99% | ✅ |
